...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        self.neo_by_designation = {neo.designation: neo for neo in self._neos}
        self.neo_by_name = {neo.name: neo for neo in self._neos}

        for approach in self._approaches:
            if approach._designation in self.neo_by_designation.keys():
    ...
    def query(self, filters=()):
        ...
        if not filters:
            ...
            for approach in self._approaches:
                checkedApproach = map(lambda filter: filter(approach), filters)
                if all(checkedApproach):
                    yield approach
